...
RESOURCES_MAP = {
    ...
    "data.inference.pdf_inference": {
        "s3_url": './dpr/data/inference/pdf_inference.csv',
        "original_ext": ".csv",
        "compressed": False,
        "desc": "NQ dev subset with passages pools for the Retriever train time validation",
        "license_files": NQ_LICENSE_FILES,
