...
###kobert tensorizer
def init_hf_kobert_tenzorizer(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError("Please install transformers lib")
    from .hf_models import get_kobert_tensorizer
    return get_kobert_tensorizer(args.encoder.pretrained_model_cfg, args.do_lower_case, args.encoder.sequence_length)
...
TENSORIZER_INITIALIZERS = {
    ...
    ### kobert
    "hf_kobert" : init_hf_kobert_tenzorizer,
}
