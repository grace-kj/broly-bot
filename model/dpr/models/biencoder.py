...
class BiEncoder(nn.Module):
    ...
    def create_biencoder_input(
        ...
        for sample in samples:
            ...
            # hard negative (high BM25 scores) 없으면 neg_ctxs로 씀
            # gold negative는 in-batch에서 다른 데이터의 정답
            ...
            tensorizer.text_to_tensor(all_ctxs[0].text, all_ctxs[0].title)
